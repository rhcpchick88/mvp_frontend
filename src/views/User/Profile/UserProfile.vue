<!-- for displaying user's personal information.
will add a carousel at top of profile for the pictures
uploaded by the user. For now I am not displaying the pics. -->
...
<template>
    <div>
        <v-card>
            ...
            <!-- to show if the user is an admin or not. -->
